...
import { useGetParkings } from "@/app/services/queries";
...
export default function Parkings() {
  ...
  return (
    ...
    <div className="container mx-auto py-15">
      <div className="list-label"><h1 className="scroll-m-20 text-4xl font-extrabold tracking-tight lg:text-5xl">Parkings list</h1></div>
